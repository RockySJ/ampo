...
from models.bnn_mmd import BNN


def construct_model(obs_dim=11, act_dim=3, rew_dim=1, hidden_dim=200, num_networks=7, num_elites=5, session=None, kernel_sigma=None):
    ...
    model.finalize(tf.train.AdamOptimizer, {"learning_rate": 0.001}, kernel_sigma=kernel_sigma)
    return model
